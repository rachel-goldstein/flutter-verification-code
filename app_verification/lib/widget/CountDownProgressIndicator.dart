...
class _CountDownProgressIndicatorState extends State<CountDownProgressIndicator>
  ...
  void initState() {
    ...
    _animation = Tween<double>(
      begin: widget.duration.toDouble(),
      end: widget.initialPosition.toDouble(),
  ...
  Widget build(BuildContext context) {
    ...
    /* print(
        "_animation.value / widget.duration ${_animation.value / widget.duration}"); */
    return Padding(
          ...
          Center(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    widget.timeFormatter?.call((_animation.value).ceil()) ??
